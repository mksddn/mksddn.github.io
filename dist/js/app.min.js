...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!function(i){"use strict"; true?!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(755)], __WEBPACK_AMD_DEFINE_FACTORY__ = (i),
...
!function() {
"use strict";
/* harmony import */ var _node_modules_slick_carousel_slick_slick_min_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(129);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function setHoverBahavior(nestedMenu, submenuToggler, submenu) {
    ...
    if (window.innerWidth > 991) {
      nestedMenu.addEventListener('mouseover', function () {
  ...
  var navmenu = document.querySelector('.navmenu-list');
  var menuLink = navmenu.querySelectorAll('.menu-item a');
  var menuButton = document.querySelector('.navmenu-button');
  var menuBurger = document.querySelector('.navmenu-burger');

  // создаем и оформляем тогглер для подменю
  var submenuTogglerElement = document.createElement('button');
  ...
  var nestedMenus = document.querySelectorAll('.navmenu .menu-item-has-children');
  ...
  nestedMenus.forEach(function (nestedMenu) {
    ...
    var submenuToggler = nestedMenu.querySelector('.sub-menu-toggle');
    var submenu = nestedMenu.querySelector('.sub-menu');
  ...
  var submenuTogglers = document.querySelectorAll('.menu-item-has-children .sub-menu-toggle');

  // для каждого тогглера
  submenuTogglers.forEach(function (toggler) {
    // определяем подменю тогглера
    var submenu = toggler.parentNode.querySelector('.sub-menu');
    // по клику на тогглер
  ...
  menuButton.addEventListener('click', function () {
    return toggleMobileMenuAndBurger();
  });
  ...
  var $slider = $('.products-carousel__wrapper');
